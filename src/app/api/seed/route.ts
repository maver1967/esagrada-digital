...
export async function POST() {
  try {
    ...
    // 5. Assignments (Fausto: Filosofia 10a & Italiano 10a/11a; Maver: Filosofia 11a)
    const assignments = [
      { classId: '10-1', subjectId: 'FIL', teacherId: 'p104' },
      ...
      { classId: '10-2', subjectId: 'FIL', teacherId: 'p104' },
    ...
    return NextResponse.json({ success: true, message: 'Base de dados semeada com sucesso!' });
  } catch (error: any) {
